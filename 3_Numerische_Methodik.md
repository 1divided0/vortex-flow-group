...
<!------------------------------------------------------------------------------
Erstellung von Ableitungsmatrizen
------------------------------------------------------------------------------->
## Erstellung von Ableitungsmatrizen

> **Begleitmaterial (Erläuterung zur Erstellung von Ableitungsmatrizen)**
>
> [![Matlab Beispiel](.Dateien/Plaketten/Matlab_Beispiel.svg)](Begleitmaterial/Ableitungsmatrizen_Matlab.md) [![Python Beispiel](.Dateien/Plaketten/Python_Beispiel.svg)](Begleitmaterial/Ableitungsmatrizen_Python.md)
...
---
> **Aufgabe (Ableitung 2d mit und ohne Rand)**
>
> Berechnet die Ableitung von `sin(x)cos(y)` wie zuvor, aber diesmal entsprechend vektorisiert und mit zweidimensionalen Ableitungsmatrizen. Vergleicht das numerische und analytische Ergebnis in einem Konturplot.
